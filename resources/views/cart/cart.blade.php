...
<body>
    ...
    <section id="cart-page" class="bg-white py-16">
        <div class="container mx-auto px-4">
            ...
            <div class="empty-cart-state flex flex-col items-center justify-center bg-white rounded-lg shadow-md p-8 mb-6 text-center">
                <img src="{{ asset('tailstore4-main/assets/images/cart-shopping.svg') }}" alt="Empty cart" class="w-28 h-28 md:w-36 md:h-36 opacity-80">
                ...
                <a href="{{ route('cuahangmaytinh') }}" class="mt-6 inline-flex items-center justify-center rounded-full bg-primary border border-primary px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-transparent hover:text-primary">Continue Shopping</a>
            </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody id="cart-items">
                                    <tr class="pb-4 border-b border-gray-line">
                                        <td class="px-1 py-4">
                                            <div class="flex items-center flex-col sm:flex-row text-center sm:text-left">
                                                <img class="h-16 w-16 md:h-24 md:w-24 sm:mr-8 mb-4 sm:mb-0" src="{{ asset('tailstore4-main/laptop/laptop_asus_rtx3060.jpg') }}" alt="Gaming Laptop RTX 4060">
                                                <p class="text-sm md:text-base md:font-semibold">Gaming Laptop RTX 4060</p>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="pb-4">
                                        <td class="px-1 py-4">
                                            <div class="flex items-center flex-col sm:flex-row text-center sm:text-left">
                                                <img class="h-16 w-16 md:h-24 md:w-24 sm:mr-8 mb-4 sm:mb-0" src="{{ asset('tailstore4-main/pc_part/rtx-4070.jpg') }}" alt="Product image">
                                                <p class="text-sm md:text-base md:font-semibold">NVIDIA RTX 4070 GPU</p>
                                            </div>
                                        </td>
                                        <td class="px-1 py-4 text-center">$19.99</td>
                                        <td class="px-1 py-4 text-center">
                            ...
                            <div class="px-1 flex flex-col lg:flex-row justify-between items-center mt-10">
                                ...
                                <div class="mt-4 lg:mt-0 flex space-x-2">
                                    <button class="bg-primary text-white border border-primary hover:bg-transparent hover:text-primary rounded-full py-2 px-4">Empty Cart</button>
                                    <button class="bg-primary text-white border border-primary hover:bg-transparent hover:text-primary rounded-full py-2 px-4">Update Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
